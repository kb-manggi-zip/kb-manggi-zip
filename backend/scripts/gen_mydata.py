...
CREATE TABLE IF NOT EXISTS transactions (
    ...
    category      TEXT NOT NULL,       -- 식비/카페/배달/구독/교통/주거/보험/쇼핑/교육/여가
    merchant_label TEXT,
