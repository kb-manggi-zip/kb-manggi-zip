...
# 확정값으로 승격(2026-07-30, 팀 승인).
# W1(2026-07-30): budget·preference도 <표 10> 원문값으로 승격 → 4축 전부 원문 확정(근사 🔴 제거).
#   preference = 부모·자녀 근접(8.1) + 자녀 양육·교육환경(3.0) = 11.1 / budget = 집값·집세 부담 8.3.
#   배제: 시설·규모 등 주택 내부속성 / 계약만기 등 비자발적 이사 / 내집마련 등 생애이벤트.
# 출처: 2024 주거실태조사 통계보고서 <표 10> '이사 이유'(전국·복수응답) / 청년의삶 실태조사(통근 39.2% 1위)
SURVEY_RATIOS = {
    "commute": 0.306,  # 직주근접·직장 변동 (확정)
    "consumption": 0.255,  # 교통편리·편의문화시설·공원녹지 복합 (확정, 기존 0.24 근사 대체)
    "budget": 0.083,  # 집값·집세 부담 (원문 확정)
    "preference": 0.111,  # 부모·자녀 근접 8.1 + 자녀 양육·교육환경 3.0 (원문 확정)
}
