...
> 모든 수치는 현재 main 실행값(2026-07-30). 관련: [에이전트_설계](에이전트_설계.md) · [개인화_설계](개인화_설계.md) · [서비스_흐름](서비스_흐름.md)
...
- **검증**: `pytest` **161건** 통과. 3갈래 계산은 **프론트 `engine/compare.ts` ↔ 백엔드 `tools/compare.py` 오차 0 동치**(`test_compare_equivalence`) + 주택금융공사 공식 계산기 앵커 대조.
