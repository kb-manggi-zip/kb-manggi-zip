...
| 스코어 가중치 근거 | `tools/scoring.py` `SURVEY_RATIOS` | `{commute:0.306, consumption:0.255, budget:0.18, preference:0.23}` | 국토부 2024 주거실태조사 이사사유(commute=직주근접, consumption=교통편리·편의문화시설·공원녹지) |
...
| weights | consumption 0.414 · commute 0.191 | commute↑ · budget↑(신혼 조정: 표36 budget×1.3, 표10·11 commute×1.15) |
