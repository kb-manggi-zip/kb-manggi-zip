...
> ⚠️ **monthlyBurden은 보증료 포함**이다(이사 774,753 = 이자 719,650 + 보증료 55,103). 화면 표시가 이걸 또 더하면 이중계산 — `검증_손계산대조.md` B-3 참고.
