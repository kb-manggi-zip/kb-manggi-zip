...
after ("재택근무예요"): commute 0.274 · consumption 0.458 · budget 0.115 · preference 0.153
→ 통근이 0.469→0.274로 낮아지고 생활·소비가 0.301→0.458로 상승, 순위 1위가 통근→생활·소비로 역전.
...
{ "segment": "1인 청년 임차 가구",
  ...
  "workplace": "판교(IT)",
  "weights": {"commute":0.274,"consumption":0.458,"budget":0.115,"preference":0.153},
