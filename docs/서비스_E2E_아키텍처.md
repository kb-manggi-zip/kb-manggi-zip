...
flowchart TB
    ...
    subgraph REGION["④ 동네 후보 (정량 개인화)"]
        ...
        SCORE["스코어 = 가중합<br/>📋 가중치: 주거실태조사 이사사유 도출<br/>통근0.315·소비0.263·선호0.237·예산0.185"]
    end
...
| **주거실태조사** (이사사유 응답률) | 국토부 2024 | ④스코어 **가중치** | "통근이 왜 0.315?"에 "이사사유 1위=직주근접30.6%"로 답(교통편리·편의문화시설·공원녹지 25.5%는 생활·소비 0.263에 대응) |
| **실거래가** 64,431건 | 국토부 오픈API | ④예산필터·⑤발품 사례 | 합성 아닌 진짜 시세 — "지난달 이 평형 N억" |
| **상권 집계** (반경500m 업종수) | 소상공인시장진흥공단 | ④소비매치·⑤발품 씬 | "카페 47곳" — 성향↔동네 매칭의 실측 근거 |
| **통근시간** | ODsay 대중교통 실측 | ④스코어·⑤발품 | 가중치 1위 축(0.315)의 실측값 |
...
flowchart LR
    subgraph 동네선정
        ...
        S --> R["1위: 길음동 0.82<br/>근거 공개: 통근28분(0.315)·카페매치(0.263)…"]
    end
    subgraph 발품
